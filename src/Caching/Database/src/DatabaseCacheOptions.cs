...
{
    /// <summary>
    /// Configuration options for <see cref="DatabaseCache"/>.
    /// </summary>
    public class DatabaseCacheOptions : IOptions<DatabaseCacheOptions>
    {
        /// <summary>
        ...
        DatabaseCacheOptions IOptions<DatabaseCacheOptions>.Value
        {
            get
            {
                return this;
